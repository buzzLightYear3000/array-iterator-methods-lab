...
const firstName = inventors.first;
const lastName = inventors.last;
...
let sortedByBirthYear = inventors.sort((a,b) => a.year > b.year ? 1 : -1)
...
let commentById = commenty.find((comment) => { 
...
let idex = commenti.findIndex(comment) => {
     comment.id === 123523
})


// Check your return value:
console.log('Exercise 9 My Result: ', idex)
